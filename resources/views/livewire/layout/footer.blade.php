...
<footer class="border-t-2 border-t-secondary bg-white dark:border-t-primary dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 dark:text-gray-400 sm:text-center">© 2024 <a class="hover:underline" href="#">Eventica™</a>. All Rights Reserved.
            </span>
            <div class="mt-4 flex sm:mt-0 sm:justify-center">
                ...
                <a class="ms-5 text-gray-500 hover:text-gray-900 dark:hover:text-white" href="#">
