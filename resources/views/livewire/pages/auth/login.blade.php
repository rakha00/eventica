...
<div>
    ...
    <form wire:submit="login">
        ...
        <div>
            ...
            <x-text-input class="mt-1 block w-full" id="email" name="email" type="email" wire:model="form.email" required autofocus autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-text-input class="mt-1 block w-full" id="password" name="password" type="password" wire:model="form.password" required autocomplete="current-password" />
