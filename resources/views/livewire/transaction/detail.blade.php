...
<div class="p-6">
    ...
    <div class="mt-4 rounded-md bg-gray-50 p-4 shadow-lg dark:bg-gray-800"> <!-- Package -->
    ...
    <div class="mt-4 rounded-md bg-gray-50 p-4 shadow-lg dark:bg-gray-800""> <!-- Total -->
        ...
        <div class="flex flex-col gap-2 sm:flex-row">
            <div class="inline-flex w-full basis-5/6 items-center justify-between rounded-md bg-gray-100 p-2 shadow-inner shadow-slate-400 dark:bg-gray-700 dark:shadow-slate-500">
                ...
                <p class="font-bold text-secondary dark:text-primary sm:text-lg">{{ 'Rp ' . number_format($totalPrice, 0, ',', '.') }}</p>
            </div>
    ...
    @endif
    <div class="mt-4 rounded-md bg-gray-50 p-4 shadow-lg dark:bg-gray-800"> <!-- Summary -->
        ...
        <div class="inline-flex w-full flex-col justify-between sm:flex-row">
            <h3 class="mb-2 font-semibold text-gray-900 dark:text-white sm:text-lg">Date</h3>
            <p class="mb-2 font-bold text-secondary dark:text-primary">{{ \Carbon\Carbon::parse($package->start_valid)->format('l, d F Y') }}</p>
        </div>
                    ...
                    <div class="rounded-md bg-gray-100 p-4 shadow-inner shadow-slate-400 dark:bg-gray-700 dark:shadow-slate-500" x-show="open">
                        <div class="overflow-x-auto">
                            <table class="w-full table-auto text-gray-900 dark:text-white">
                                <thead>
                                    <tr>
                                        <th class="border border-gray-900 px-2 py-2 text-xs dark:border-gray-50">Qty</th>
                                        <th class="border border-gray-900 px-4 py-2 text-xs dark:border-gray-50">Item</th>
                                        <th class="border border-gray-900 px-4 py-2 text-xs dark:border-gray-50">Price</th>
                                        <th class="border border-gray-900 px-4 py-2 text-xs dark:border-gray-50">Total</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td class="border border-gray-900 px-2 py-2 text-xs dark:border-gray-50">{{ $quantity }}</td>
                                        ...
                                        <td class="border border-gray-900 px-4 py-2 text-xs dark:border-gray-50">{{ 'Rp ' . number_format($package->price, 0, ',', '.') }}</td>
                                        <td class="border border-gray-900 px-4 py-2 text-xs dark:border-gray-50">{{ 'Rp ' . number_format($package->price * $quantity, 0, ',', '.') }}</td>
                                    </tr>
                                    <tr>
                                        <td class="border border-gray-900 px-2 py-2 text-xs dark:border-gray-50"></td>
                                        <td class="border border-gray-900 px-4 py-2 text-xs dark:border-gray-50">Promo</td>
                                        <td class="border border-gray-900 px-4 py-2 text-xs dark:border-gray-50">Rp 0</td>
                                        <td class="border border-gray-900 px-4 py-2 text-xs dark:border-gray-50">Rp 0</td>
                                    </tr>
                                    <tr>
                                        <td class="border border-r-0 border-gray-900 px-2 py-2 text-xs font-bold dark:border-gray-50">Total</td>
                                        <td class="border border-b border-gray-900 px-4 py-2 text-xs dark:border-gray-50"></td>
                                        <td class="border border-b border-gray-900 px-4 py-2 text-xs dark:border-gray-50"></td>
                                        <td class="border border-gray-900 px-4 py-2 text-xs font-bold dark:border-gray-50">{{ 'Rp ' . number_format($package->price * $quantity, 0, ',', '.') }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
